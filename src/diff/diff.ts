 ...
 * - **Version fast path** (see docs/cursors.md): when `version` is non-null and the stored row has the same
...
/**
 * Compare candidates against the stored rows and decide what changed (see docs/cursors.md).
 *
