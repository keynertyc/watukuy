 ...
 * 1.0 structured mode, PLAN §4.6); `'raw'` transports the {@link WatukuyEvent} envelope as-is,
...
/**
 * Serialize an event to a JSON string and the matching `content-type` (PLAN §4.6). Use it when
