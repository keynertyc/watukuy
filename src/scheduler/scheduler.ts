...
/**
 * Adaptive scheduler (PLAN §5.6). Every function here is pure: it reads a {@link ScheduleState},
...
/**
 * Proactive rate-limit pacing (PLAN §5.6). When the API advertises `remaining` and `resetAt`,
