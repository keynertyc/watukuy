...
/** Per-request options for `ctx.http.get()` / `ctx.http.request()` (see docs/http-helper.md). */
...
/** The `ctx.http` helper (see docs/http-helper.md). Never retries: the scheduler owns retries. */
