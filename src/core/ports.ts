...
/** Time source. Injectable so the whole engine is deterministic under test (guarantee G8). */
...
/**
 * Lifecycle hooks (see docs/observability.md). All optional, may be sync or async; errors thrown by hooks are
